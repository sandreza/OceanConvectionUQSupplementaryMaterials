...
field_writer = JLD2OutputWriter(model, fields; dir=base_dir, prefix="strat_fields",
...
profile_writer = JLD2OutputWriter(model, profiles; dir=base_dir, prefix = "strat_profiles",
                                  init=init_save_parameters_and_bcs,
