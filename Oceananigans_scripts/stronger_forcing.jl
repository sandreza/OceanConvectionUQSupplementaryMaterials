...
field_writer = JLD2OutputWriter(model, fields; dir=base_dir, prefix="stronger_forcing_fields",
...
profile_writer = JLD2OutputWriter(model, profiles; dir=base_dir, prefix = "stronger_forcing_profiles",
                                  init=init_save_parameters_and_bcs,
...
while model.clock.time < end_time
    walltime = @elapsed time_step!(model; Nt=Ni, Δt = 1.0)
